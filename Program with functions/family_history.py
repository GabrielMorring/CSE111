...
def print_death_age(people_dict):
    ...
    for item in people_dict.items():
        ...
        x = value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX]
    

        print(f'{name} died at {x} years old.')
...
def count_genders(people_dict):
    ...
    print(f'Male count: {male}, Female count: {female}.')
...
def print_marriages(marriages_dict, people_dict):
    ...
    Return: nothing
    """
    for items in marriages_dict.items():
        value = items[1]
        ...
        husband_value = people_dict[husband_key]
        husband_name = husband_value[0]
        husband_age = wedding_year - husband_value[2]

        wife_value = people_dict[wife_key]
        wife_name = wife_value[0]
        wife_age = wedding_year - wife_value[2]

        print(f'{husband_name} {husband_age} {wedding_year}')
        print(f'{wife_name} {wife_age}')
        print()
